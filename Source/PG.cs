...
namespace ApiExternalTestApp
{
    public partial class MainWindow : Form
    {
        ...
        {
            newMessage = String.Format("Получен плановыq график {0} по станции {1} на {2} \r\n", ModesUtils.PlanTypeToString(e.Type),
                e.ClientId, e.Day.SystemToLocalHqEx().ToShortDateString());
